...
exports.findAll = (req, res) => {
    ...
    if(req.query.visible)
        // SI VIENE UN PARÁMETRO visible, SE CREA EL OBJETO (whereStatement.visible). ESTO ES EQUIVALENTE A HACER LA CONSULTA A LA BDD.
        whereStatement.visible = {[Op.substring]: req.query.visible};
        // EN ESTE CASO SE ESTÁ UTILIZANDO . OTRA OPCIÓN a substring ES USAR like, PERO EN ESE CASO SE CONCATENARÍA -> `%${req.query.visible}%`
